...
def fun(t_reg_estacionario=2700, t_final_batch=2700, T=294, Ua0=0.000605, Ub0=0.000713, Vreactor=1.45, Ca0_t=0.1, Cb0_t=0.1, dt=60):
...
w=interactive(fun, {'manual':True}, t_reg_estacionario=IntSlider(min=1, max=8000, value=5400, step=60, description='$t_{r.estac}$'),  t_final_batch=IntSlider(min=1, max=5400, value=2700, step=60, description='$t_{batch}$'), T=IntSlider(min=1, max=500, value=294, description='$Temp.$'), Ua0=FloatSlider(min=1E-4, max=1E-3, value=0.000605, step=0.0001, description='$U_{a0}$', readout_format='.4f'), Ub0=FloatSlider(min=1E-4, max=0.001, value=0.000713, step=0.0001,  description='$U_{b0}$', readout_format='.4f'), Vreactor=FloatSlider(min=1, max=20, value=1.45, description='$V_{reactor}$'), Ca0_t=FloatSlider(min=0, max=1, value=0.1, description='$C_{a0}$', step=0.01), Cb0_t=FloatSlider(min=0, max=1, value=0.1,  description='$C_{b0}$', step=0.01), dt=IntSlider(min=1, max=100, value=60, description='$dt$'))
